...
# Players are presented with an algebraic problem and must select the correct
# answer from multiple choices. If they answer correctly they gain control of the equation,
# which will be displayed as the complete solution. They can move left or right or drop it.
# The goal is to position the equations similar to tetris and the game continues
# until the player reaches 3 strikes, the grid fills up to the top, the player
...
LEVELS:
    .word 5
CHOICES:
    .word 4    # Number of answer choice
HEIGHT:
    .word 15    # Grid Height
WIDTH:
    .word 40    # Grid Width
...
operator:
    .word 0
options:
    .space 16    # 4 options * 4 bytes
choices:
    .byte 'a', 'b', 'c', 'd'    # Answer choices
# Extra Variables
equation:
    .space 32    # Space for equation length (at at
least 31 chars + null)
placeX:
    .word 0
placeY:
...
\n====================================\n"
start_print:
    .asciiz "Press any key to get started..."
level_msg1:
    .asciiz "\n=== LEVEL "
level_msg2:
    .asciiz "===\n\n"
...
stats_bar:
    .asciiz " | |"
moving_print:
    .asciiz "Move equation: left (L), right (R), or
drop (F): "
left_print:
    .asciiz " Moving left... "
left_bound:
...
enter_print:
    .asciiz "\nPress F\n"
landed_print:
    .asciiz "Equation landed! "
incorr_print:
    .asciiz "INCORRECT! The correct answer was "
full_print:
    .asciiz "GAME OVER! GRID IS STACKED TOO HIGH!"
adv_level_msg1:
    .asciiz "Advancing to level "
adv_level_msg2:
    .asciiz "!\n"
continue_print:
    .asciiz "\nPress ENTER to continue...\n"
max_strike_msg:
    .asciiz "GAME OVER! 3 strikes, YOU'RE OUT!"
congrats_print:
    .asciiz "CONGRATULATIONS! You have completed
...
choice_print:
    .asciiz "Enter your choice (a, b, c, d):"
invalid_letter:
    .asciiz "Invalid Input: Please enter a, b, c, or d.\n"
vert_border:
    .asciiz "|"
horz_border:
    .asciiz "-"
...
# Calculate second threshold (70 - (level * 2))
    ...
    mul $t6, $t2, 2
    sub $t5, $t5, $t6
    blt $t4, $t5, use_subtraction
# t5 = second threshold
    li $t5, 90
    blt $t4, $t5, use_multiplication
...
# Place equation at top with target value still marked as ?
    ...
    sub $t1, $t1, $t0
    srl $t1, $t1, 1
    sw $t1, placeX # t1 = WIDTH - strlen(equation)
# t1 = (WIDTH - strlen) / 2
# placeX = t1
    li $t1, 0
    sw $t1, placeY # placeY = 0
...
scan_slots:
    sub $t5, $t4, $t3
    bltz $t5, check_bottom # t5 = 14 - offset
# if row < 0 -> fallback
    li $t6, 0
...
# num1 = rand() % maxNum + 1
    li $v0, 42
    move $a1, $t1 the random function
...
# the operator symbol
    ...
    addi $t1, $t1, 1
    move $a0, $a3
    move $a1, $t1 jal integerToString
    move $t1, $v0
# a0 = target
...
integerToString:
    ...
    sw $t5, 0($sp)
    move $t9, $a1
    move $t1, $a0 # t9 = write pointer into buffer
# t1 = number printing
# Special case 0
beqz $t1, zero_case
